                                    ...
                                    <div class="">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="product-single-qty">
                                                ...
                                                <input class="horizontal-quantitys form-control quantity " name="quantity"
                                                    min="1"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.update-cart-btn').click(function(e) {
                ...
                var product_id = $(this).closest('.product-row').find('.product_id').val();
        ...
        function updatePrice(data, id, price) {
            ...
            $('#subtotal').html(parseFloat(newTotal).toFixed(2))
            $('#totalAmount').html(parseFloat(newTotal).toFixed(2))
            $('#quantity_total_' + id).html(parseFloat(priceVal).toFixed(2))
        }
    </script>
@endsection
