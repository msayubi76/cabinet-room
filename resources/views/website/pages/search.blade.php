                        ...
                        <div class="collapse show" id="widget-body-3">
                            <div class="widget-body pb-0">
                                <form action="{{route('searchProduct')}}"  method="GET">
                                    @csrf
                                <input type="hidden" name="name" value="{{$product_search}}">
                                ...
                                <div class="range-input">
                                    <input type="range" class="range-min"  min="{{$min}}" max="{{$max}}" value="{{$minPrice?$minPrice:$min}}" step="100">
                                    <input type="range" class="range-max" min="{{$min}}" max="{{$max}}" value="{{$maxPrice?$maxPrice:$max}}" step="100">
                                </div>
