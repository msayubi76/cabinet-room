                                ...
                                @foreach ($cart as $cartlist)
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="/product/{{ $cartlist->product_id }}" class="product-image">
                                                <img src="{{ asset($cartlist->product->feature_image) }}"
                                                    alt="product" width="80" height="80">
                                            </a>
                                            <input type="hidden" class="product_id"
                                                value='{{ $cartlist->product_id }}'>

                                            <a class=" btn-remove" title="Remove Product" href="javascript:;"
            ...
            <nav class="main-nav w-100">
                <ul class="menu d-flex">
                    ...
                    @foreach ($categories as $catlist)
                        <li>
                            <a
                                href=" {{ route('products', ['category' => $catlist->name]) }} ">{{ $catlist->name }}</a>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <ul class="submenu">
                                                @foreach ($catlist->subcategories as $subcatlist)
                                                    <li><a
                                                            href="{{ route('products', ['category' => $catlist->name, 'sub_category' => $subcatlist->name]) }} ">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary px-4 py-2 " data-dismiss="modal">No</button>
                    <button type="button" id="button-delete" class="btn btn-primary px-4 py-2"
