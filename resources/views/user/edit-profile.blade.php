                                ...
                                <div class="col-md-12 col-xl-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            @include('alertsInfo')
                                            <form class="custom-validation" enctype="multipart/form-data"  method="post"action="{{url('user/update-profile/'.encrypt($user->id)) }}">
                                                @csrf
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <input class="form-control"   placeholder="Address" name="address" type="text" value="{{empty(old('address')) ? $user->name :old('address')}}">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input" name="file" multiple id="inputGroupFile04">
