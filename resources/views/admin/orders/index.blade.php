                                            ...
                                            <div class="btn-group">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item" href="javascript:openConfirmationDialog('Accepted',{{$order->id}})" class="btn btn-sm btn-primary">Accept Order</a>
                                                        <a class="dropdown-item" href="javascript:openConfirmationDialog('Completed',{{$order->id}})" class="btn btn-sm btn-primary">Complete Order</a>
                                                        <a class="dropdown-item" href="javascript:openConfirmationDialog('Rejected',{{$order->id}})" class="btn btn-sm btn-primary">Reject Order</a>
                                                        <a class="dropdown-item" href="javascript:openConfirmationDialog('Canceled',{{$order->id}})" class="btn btn-sm btn-primary">Cancel Order</a>
                                                        ...
                                                        <a class="dropdown-item" href="javascript:openPaymentModal({{ json_encode($order) }})">Payment</a>
                                                        <a class="dropdown-item" href="{{ url('admin/view-order/'.$order->id) }}" class="btn btn-sm btn-primary">View</a>
                                                        <a class="dropdown-item" href="{{ url('admin/order/'.$order->id) }}" class="btn btn-sm btn-primary">Payment History</a>
...
<div class="modal fade" id="changeStatus" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                <button type="button" id="button-delete" class="btn btn-primary" onclick="updateStatus()">Yes</button>
            </div>
        </div>
    </div>
</div>
