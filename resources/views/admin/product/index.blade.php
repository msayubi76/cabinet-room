                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-4 text-right">
                            @can('create-product')
                            <a href="{{url('admin/products/create')}}" class="btn btn-sm btn-primary">Add Products</a>
                            @endcan
                            ...
                            <tbody id="table_id">
                                ...
                                <tr id='row_{{$list->id}}'>
                                    ...
                                    <td class="text-center">
                                        <span class="badge badge-{{ $list->is_active == '1' ? 'success' : 'warning' }}">
                                            ...
                                            <div class="btn-group">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" onclick="openViewModal( )">View</a>
                                                        @can('update-product')
                                                        <a class="dropdown-item" href="{{url('admin/products/'.$list->id.'/edit')}}">Edit</a>
                                                        @endcan
                                                        @can('delete-product')
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="button-delete" class="btn btn-primary" onclick="deleteProduct()">Yes</button>
            </div>
        </div>
    </div>
</div>
