                        ...
                        <form action="{{route('products.store')}}" method="Post" id="product-form" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-8">
                                <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control" id="feature_image" name="feature_image" placeholder="feature image" :value="old('feature_image')">
                                    @error('feature_image')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control" id="images" name="images[]" placeholder="images" :value="old('images')" multiple>
                                    @error('images')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row ">
                                <div class="col-md-2 mb-8">
                                    <label class=" col-form-label form-check-label y-8" for="name" style="margin-top: 30px;">
                                        ...
                                        <input type="checkbox" class="form-check-input" name="is_active" checked value="1" {{ old('is_active') == '1' ? 'checked' : '' }}>Available<span class="text-danger">*</span> </label>
                                    @error('is_active')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-2 mb-8">
                                    <label class=" col-form-label form-check-label y-8" for="name" style="margin-top: 30px;">
                                        ...
                                        <input type="checkbox" class="form-check-input" name="is_feature_product" value="1" {{ old('is_feature_product') == '1' ? 'checked' : '' }}>Feature Product<span class="text-danger">*</span> </label>
                                ...
                                <div class="col-md-2 mb-8">
                                    <label class=" col-form-label form-check-label" for="name" style="margin-top: 30px;">
                                        ...
                                        <input type="checkbox" class="form-check-input" name="is_arrival_product" value="1" {{ old('is_arrival_product') == '1' ? 'checked' : '' }}>Arrival Product<span class="text-danger">*</span> </label>
                                ...
                                <div class="col-md-2 mb-8">
                                    <label class=" col-form-label form-check-label" for="name" style="margin-top: 30px;">
                                        ...
                                        <input type="checkbox" class="form-check-input" name="is_for_request_quote" value="1" {{ old('is_for_request_quote') == '1' ? 'checked' : '' }}>Request Quote<span class="text-danger">*</span> </label>
                                ...
                                <div class="col-md-4">
                                    <label for="">Delivered-in<span class="text-danger">*</span></label>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control"  placeholder="01-05 Working days/months" value="{{old('delivered_in')}}" name="delivered_in" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                ...
                                <div class="col-md-4">
                                    <label for="">Reviews<span class="text-danger">*</span></label>
                                    <input type="number" class="form-control input-default" min="1" max="5" placeholder="Rate" value="{{old('rating')}}" name="rating">
                                    @error('rating')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div  class="col-md-4">
                                    <input type="checkbox" class="form-check-input" name="is_installment_available" value="1" {{ old('is_installment_available') == '1' ? 'checked' : '' }}>Installment Available </label>
                                </div>
                            </div>
                            <div class="form-group mb-8">
