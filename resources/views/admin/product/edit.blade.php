                            ...
                            <form action="{{ route('products.update', $product->id) }}" method="post" id="edit-product-form"
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control"  placeholder="01-05 Working days/months" value="{{ $product->delivered_in }}" name="delivered_in" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control input-default" min="1" max="5" placeholder="Rate" value="{{ $product->rating }}" name="rating">
                                    @error('rating')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div  class="col-md-4 mt-4 ">
                                    <label for="is_installment_available">
                                    <input type="checkbox" id="is_installment_available" class="form-check-input" name="is_installment_available" value="1" 
