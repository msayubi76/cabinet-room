...
class FrontendController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('website.index', compact('categories',  'featuredProducts', 'arrivialProducts',   'banners',  'categoriesWithProducts'));
    }
    ...
    public function products(Request $request, $category = null, $sub_category = null)
    {
        ...
        return view('website.pages.shop', compact('categories',  'products',   'featuredProducts', 'min', 'max', 'min_price', 'max_price', 'banner'));
    }
