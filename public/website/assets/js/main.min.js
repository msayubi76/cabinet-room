            ...
            c = {
                ...
                lightBox: function () {
                    ...
                    (e = t(".product-slider-container").length > 0 ? t(".product-single-carousel .owl-item:not(.cloned) img") : t(".product-single-gallery img")),
                        ...
                        t("body").on("click", "a.btn-quickview", function (e) {
                            e.preventDefault();
                            var i = t(this);
                            i.closest(".product-default").find("figure").hasClass("load-more-overlaya") ||
                                (i.closest(".product-default").find("figure").addClass("load-more-overlaya"), i.closest(".product-default").find("figure").append('<i class="porto-loading-icona"></i>'));
                                ...
                                t.magnificPopup.open({
                                    ...
                                    callbacks: {
                                        ...
                                        ajaxContentAdded: function () {
                                            c.ajaxLoading(),
                                                i.closest(".product-default").find("figure").removeClass("load-more-overlaya"),
                                                i.closest(".product-default").find("figure .porto-loading-icona").remove(),
                ...
                productsWishlistAction: function () {
                    t("body").on("click", ".btn-icon-wish:not(.added-wishlist)", function (e) {
                        e.preventDefault();
                        var i = t(this);
                        i.addClass("load-more-overlaya loading"),
                            setTimeout(function () {
                                i.removeClass("load-more-overlaya loading"),
